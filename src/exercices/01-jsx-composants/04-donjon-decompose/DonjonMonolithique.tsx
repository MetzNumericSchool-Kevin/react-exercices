/**
 * ⚠️ NE PAS MODIFIER CE FICHIER — c'est la version de départ, garde-la comme référence.
 * Lis le README.md pour les instructions.
 */
export default function DonjonMonolithique() {
  return (
